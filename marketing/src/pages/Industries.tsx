...
export default function Industries() {
  return (
    <>
      <SEO
        title="Industries — AgentlyAI"
        description="AgentlyAI is built first for fashion & apparel retailers in India, with more categories on the way."
        path="/industries"
      />
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-gray-600">
            AgentlyAI is purpose-built for how Indian fashion brands sell — variant-heavy
            catalogues, WhatsApp-first customers, and UPI/COD payments.
          </p>
        </div>

        <div className="mt-12 rounded-3xl bg-gradient-to-br from-indigo-50 to-violet-50 p-8 ring-2 ring-indigo-600">
          <h2 className="text-2xl font-bold text-gray-900">Fashion &amp; Apparel</h2>
          <p className="mt-3 text-gray-700">
            Sarees, kurtis, lehengas, suits, and more. AgentlyAI understands color, size, and
